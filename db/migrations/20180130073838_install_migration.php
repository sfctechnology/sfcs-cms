...
(11, \'defaultTimezone\', \'Europe/Istanbul\', \'timezone\', \'Set the default timezone for the application\', \'Europe/London\', \'regional\', 1, \'Timezone\', \'\', 20, \'Europe/London\', 1, \'string\'),
(18, \'mail_to\', \'cms@sfcteknoloji.com.tr\', \'email\', \'Errors will be mailed here\', NULL, \'maintenance\', 1, \'Admin email address\', \'\', 30, \'mail@yoursite.com\', 1, \'string\'),
(19, \'mail_from\', \'cms@sfcteknoloji.com.tr\', \'email\', \'Mail will be sent from this address\', NULL, \'maintenance\', 1, \'Sending email address\', \'\', 40, \'mail@yoursite.com\', 1, \'string\'),
(30, \'audit\', \'Error\', \'dropdown\', \'Set the level of logging the CMS should record. In production systems "error" is recommended.\', \'Emergency|Alert|Critical|Error|Warning|Notice|Info|Debug\', \'troubleshooting\', 0, \'Log Level\', \'\', 20, \'error\', 1, \'word\'),
(33, \'LIBRARY_LOCATION\', \'\', \'text\', \'The fully qualified path to the CMS library location.\', NULL, \'configuration\', 0, \'Library Location\', \'required\', 10, \'\', 1, \'string\'),
(34, \'SERVER_KEY\', \'\', \'text\', NULL, NULL, \'configuration\', 0, \'CMS Secret Key\', \'required\', 20, \'\', 1, \'string\'),
(35, \'HELP_BASE\', \'/manual/en/\', \'text\', NULL, NULL, \'general\', 1, \'Location of the Manual\', \'required\', 10, \'/manual/\', 1, \'string\'),
...
(38, \'PHONE_HOME_URL\', \'\', \'text\', \'The URL to connect to to PHONE_HOME (if enabled)\', NULL, \'network\', 0, \'Phone home URL\', \'\', 60, \'\', 0, \'string\'),
...
(40, \'SERVER_MODE\', \'Production\', \'dropdown\', \'This should only be set if you want to display the maximum allowed error messaging through the user interface. <br /> Useful for capturing critical php errors and environment issues.\', \'Production|Test\', \'troubleshooting\', 0, \'Server Mode\', \'\', 30, \'Production\', 1, \'word\'),
(41, \'MAINTENANCE_ENABLED\', \'Protected\', \'dropdown\', \'Allow the maintenance script to run if it is called?\', \'Protected|On|Off\', \'maintenance\', 0, \'Enable Maintenance?\', \'\', 10, \'Off\', 1, \'word\'),
(42, \'MAINTENANCE_EMAIL_ALERTS\', \'Off\', \'dropdown\', \'Global switch for email alerts to be sent\', \'On|Off\', \'maintenance\', 1, \'Enable Email Alerts?\', \'\', 20, \'On\', 1, \'word\'),
(43, \'MAINTENANCE_KEY\', \'sfcteknoloji\', \'text\', \'String appended to the maintenance script to prevent malicious calls to the script.\', NULL, \'maintenance\', 0, \'Maintenance Key\', \'\', 50, \'changeme\', 1, \'string\'),
(44, \'MAINTENANCE_LOG_MAXAGE\', \'5\', \'number\', \'Maximum age for log entries. Set to 0 to keep logs indefinitely.\', NULL, \'maintenance\', 0, \'Max Log Age\', \'\', 60, \'30\', 1, \'int\'),
(45, \'MAINTENANCE_STAT_MAXAGE\', \'60\', \'number\', \'Maximum age for statistics entries. Set to 0 to keep statistics indefinitely.\', NULL, \'maintenance\', 0, \'Max Statistics Age\', \'\', 70, \'30\', 1, \'int\'),
(46, \'MAINTENANCE_ALERT_TOUT\', \'30\', \'number\', \'How long in minutes after the last time a client connects should we send an alert? Can be overridden on a per client basis.\', NULL, \'maintenance\', 1, \'Max Display Timeout\', \'\', 80, \'12\', 1, \'int\'),
...
(49, \'MAINTENANCE_ALWAYS_ALERT\', \'Off\', \'dropdown\', \'Should Xibo send an email if a display is in an error state every time the maintenance script runs?\', \'On|Off\', \'maintenance\', 0, \'Send repeat Display Timeouts\', \'\', 80, \'Off\', 1, \'word\'),
...
(57, \'USER_PASSWORD_ERROR\', \'\', \'text\', \'A text description of this password policy. Will be show to users when their password does not meet the required policy\', \'\', \'users\', 0, \'Description of Password Policy\', \'\', 30, \'\', 1, \'string\'),
(58, \'MODULE_CONFIG_LOCKED_CHECKB\', \'Checked\', \'dropdown\', \'Is the module config locked? Useful for Service providers.\', \'Checked|Unchecked\', \'defaults\', 0, \'Lock Module Config\', \'\', 30, \'Unchecked\', 0, \'word\'),
...
(63, \'GLOBAL_THEME_NAME\', \'default\', \'text\', \'The Theme to apply to all pages by default\', NULL, \'configuration\', 0, \'CMS Theme\', \'\', 30, \'default\', 0, \'word\'),
...
(67, \'SETTING_IMPORT_ENABLED\', \'0\', \'checkbox\', NULL, NULL, \'general\', 0, \'Allow Import?\', \'\', 80, \'1\', 1, \'checkbox\'),
(68, \'SETTING_LIBRARY_TIDY_ENABLED\', \'0\', \'checkbox\', NULL, NULL, \'general\', 1, \'Enable Library Tidy?\', \'\', 90, \'1\', 1, \'checkbox\'),
...
(71, \'PROXY_HOST\', \'\', \'text\', \'The Proxy URL\', NULL, \'network\', 0, \'Proxy URL\', \'\', 10, \'\', 1, \'string\'),
(72, \'PROXY_PORT\', \'0\', \'number\', \'The Proxy Port\', NULL, \'network\', 0, \'Proxy Port\', \'\', 20, \'0\', 1, \'int\'),
(73, \'PROXY_AUTH\', \'\', \'text\', \'The Authentication information for this proxy. username:password\', NULL, \'network\', 0, \'Proxy Credentials\', \'\', 30, \'\', 1, \'string\'),
...
(97, \'DISPLAY_PROFILE_SCREENSHOT_INTERVAL_ENABLED\', \'0\', \'checkbox\', NULL, NULL, \'displays\', 1, \'Enable the option to set the screenshot interval?\', \'\', 90, \'0\', 1, \'checkbox\'),
...
(99, \'LATEST_NEWS_URL\', \'\', \'text\', \'RSS/Atom Feed to be displayed on the Status Dashboard\', \'\', \'general\', 0, \'Latest News URL\', \'\', 111, \'\', 0, \'string\'),
...
INSERT INTO `module` (`ModuleID`, `Module`, `Name`, `Enabled`, `RegionSpecific`, `Description`, `ImageUri`, `SchemaVersion`, `ValidExtensions`, `PreviewEnabled`, `assignable`, `render_as`, `settings`, `viewPath`, `class`, `defaultDuration`) VALUES
  ...
  (4, \'PowerPoint\', \'PowerPoint\', 0, 0, \'Upload a PowerPoint file to assign to Layouts\', \'forms/powerpoint.gif\', 1, \'ppt,pps,pptx\', 1, 1, NULL, NULL, \'../modules\', \'Xibo\\\\Widget\\\\PowerPoint\', 10),
  ...
  (12, \'shellcommand\', \'Shell Command\', 0, 1, \'Instruct a Display to execute a command using the operating system shell\', \'forms/shellcommand.gif\', 1, NULL, 1, 1, NULL, NULL, \'../modules\', \'Xibo\\\\Widget\\\\ShellCommand\', 3),
  (13, \'localvideo\', \'Local Video\', 0, 1, \'Display Video that only exists on the Display by providing a local file path or URL\', \'forms/video.gif\', 1, NULL, 0, 1, NULL, NULL, \'../modules\', \'Xibo\\\\Widget\\\\LocalVideo\', 60),
